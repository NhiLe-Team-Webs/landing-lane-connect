...
const ShareSection = ({ pdfUrl, tagline }: { pdfUrl?: string; tagline?: string }) => {
        ...
        <div className="flex gap-2.5 justify-center flex-wrap">
          {pdfUrl && (
            <a
              ...
              className="px-5 py-2.5 text-[13px] font-bold rounded-xl bg-foreground text-background border-none transition-all hover:opacity-90"
            >
              📥 Tải PDF về máy
            </a>
          )}
